...
class _HomeScreenState extends State<HomeScreen> {
  int selectedIndex = 0;
  final List<String> tabs = ["current mathes", "Cricscore", "PlayerInfo"];
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => Crick11SearchScreen(),
                        ),
                      );
                    },
                    child: Image.asset(
                  ...
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    return Center(
                      child: CircularProgressIndicator(
                        color: const Color.fromARGB(255, 12, 37, 81),
                      ),
                    );
                            ...
                            onTap: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder:
                                      (contex) =>
                                          MatchDetailScreen(cricmatch: match),
                                ),
                              );
                            },
                            child: Container(
